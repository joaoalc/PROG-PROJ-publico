...
Logical Programming subject. The goal of this project was to develop a program capable creating and solving every instance of the lightbulb puzzle. The goal of this puzzle is to find every lit lightbulb, considering that a lightbulb is only lit when the number inside it is equal to the number of lit neighboring lamps (including itself).
